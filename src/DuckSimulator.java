...
public class DuckSimulator {
    public static void main (String[] args) {
        ...
        //factories.AbstractDuckFactory duckFactory = new factories.CountingAndEchoDuckFactory();
        //factories.AbstractDuckFactory duckFactory = new factories.DuckFactory();
    ...
    void simulate(AbstractDuckFactory duckFactory) {
        ...
        //animals.Quackable pigeon = new adapters.PigeonAdapter(new animals.Pigeon());
